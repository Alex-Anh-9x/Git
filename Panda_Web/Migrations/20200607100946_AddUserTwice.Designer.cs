...
namespace Panda_Web.Migrations
{
    ...
    [Migration("20200607100946_AddUserTwice")]
    partial class AddUserTwice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Panda_Web.Models.ActivityList", b =>
                {
            ...
            modelBuilder.Entity("Panda_Web.Models.AdminSetup", b =>
                {
            ...
            modelBuilder.Entity("Panda_Web.Models.CompletedActivity", b =>
                {
            ...
            modelBuilder.Entity("Panda_Web.Models.CompletedFmtrans", b =>
                {
            ...
            modelBuilder.Entity("Panda_Web.Models.CompletedInvitation", b =>
                {
                    b.Property<int>("ActivityId")
                        .HasColumnName("ActivityID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Panda_Web.Models.CompletedPhotoRequest", b =>
                {
            ...
            modelBuilder.Entity("Panda_Web.Models.CompletedPhotoTransaction", b =>
                {
            ...
            modelBuilder.Entity("Panda_Web.Models.CompletedReportTransaction", b =>
                {
                    b.Property<DateTime?>("DateCompleted")
                        .HasColumnType("datetime");
            ...
            modelBuilder.Entity("Panda_Web.Models.CountryStateCity", b =>
                {
            ...
            modelBuilder.Entity("Panda_Web.Models.PendingActivity", b =>
                {
                    b.Property<string>("Activities")
                        .IsRequired()
                        .HasColumnType("nchar(30)")
            ...
            modelBuilder.Entity("Panda_Web.Models.PendingBattleRequest", b =>
                {
            ...
            modelBuilder.Entity("Panda_Web.Models.PendingFmtrans", b =>
                {
                    b.Property<string>("Chooser")
                        .IsRequired()
                        .HasColumnType("varchar(50)")
            ...
            modelBuilder.Entity("Panda_Web.Models.PendingInvitation", b =>
                {
                    b.Property<int>("ActivityId")
                        .HasColumnName("ActivityID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Panda_Web.Models.PendingPhotoRequest", b =>
                {
                    b.Property<int?>("AcceptedVote")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Panda_Web.Models.PendingPhotoTransaction", b =>
                {
                    b.Property<int?>("Approve")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Panda_Web.Models.PendingReportTransaction", b =>
                {
                    b.Property<DateTime?>("DateReported")
                        .HasColumnType("datetime");
            ...
            modelBuilder.Entity("Panda_Web.Models.ProductCatalog", b =>
                {
            ...
            modelBuilder.Entity("Panda_Web.Models.ReferalIncome", b =>
                {
                    b.Property<DateTime>("DateCreated")
                        .HasColumnType("datetime");
            ...
            modelBuilder.Entity("Panda_Web.Models.ReportList", b =>
                {
            ...
            modelBuilder.Entity("Panda_Web.Models.SalesTransaction", b =>
                {
                    b.Property<int?>("ProductId")
                        .HasColumnName("ProductID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Panda_Web.Models.UserTable", b =>
                {

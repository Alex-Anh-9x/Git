...
namespace Pada.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new PadaUser { UserName = Input.Email, Email = Input.Email, Gender = Input.Gender, UserLevel = 3};
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        var newUser = new UserTable() { Gender = (user.Gender == "Male") ? 1 : (user.Gender == "Female") ? 2 : 3, Email = user.Email, DateJoined = DateTime.UtcNow, AccountStatus = 2, UserLevel = 3,AccessToken = "123456", Password = "123456"};
